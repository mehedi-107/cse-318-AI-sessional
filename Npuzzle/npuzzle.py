...
if __name__ == "__main__":
    ...
    # config = []
    # print("Enter the puzzle configuration row by row (0 for blank space):")
    # for _ in range(n):
    ...
    #     print("Number of node expanded: " + str(len(puzzle.close_list)))
    ...
    #     print("Number of node expanded: " + str(len(puzzle2.close_list)))
    ...
    #     print("Number of node expanded: " + str(len(puzzle3.close_list)))
    ...
    #     print("Number of node expanded: " + str(len(puzzle4.close_list)))
    ...
    if os.path.exists("input.txt"):
        ...
        with open("output.txt", "w") as f:
            if result:
                ...
                f.write("Number of node expanded: " + str(len(puzzle.close_list)) + "\n")
            ...
            if result2:
                ...
                f.write("Number of node expanded: " + str(len(puzzle2.close_list)) + "\n")
            ...
            if result3:
                ...
                f.write("Number of node expanded: " + str(len(puzzle3.close_list)) + "\n")
            ...
            if result4:
                ...
                f.write("Number of node expanded: " + str(len(puzzle4.close_list)) + "\n")
